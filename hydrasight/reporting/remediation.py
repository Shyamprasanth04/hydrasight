...
_REMEDIATION_MAP: list[tuple[str, str, str]] = [
    ...
    ("ms08", "CRITICAL",
     "Apply MS08-067 patch (KB958644). "
     "Migrate all Windows 2000/XP endpoints immediately."),
    ("anonymous ftp", "HIGH",
     "Disable anonymous FTP login. "
     "Migrate to SFTP with key-based authentication."),
    ("vsftpd", "CRITICAL",
     "Upgrade vsftpd to 3.0.5+. "
     "The 2.3.4 backdoor is publicly known and trivially exploitable."),
    ("proftpd", "HIGH",
    ...
    ("libssh", "HIGH",
     "Upgrade libssh to 0.8.4+. "
     "CVE-2018-10933 allows authentication bypass on server mode."),
    ("distcc", "HIGH",
    ...
    ("java rmi", "HIGH",
     "Disable Java RMI registry if not required. "
     "Apply latest JDK security patches."),
    ("smb", "MEDIUM",
     "Enable SMB signing: "
